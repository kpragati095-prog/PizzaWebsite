...
<div class="content">
    <h2 class="mb-4">pizza Product List</h2>
    <table class="table table-bordered table-hover bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="pizzaedit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                    <a href="pizzadelete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this product?')">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
